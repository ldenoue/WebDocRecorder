"use strict";
	...
	function BlobExtractionLaurent_u8(label,data, w, h) {
		//console.log('blob');
		var max = w * h;
    ...
    //Laurent: found we should not do that because it will mess up boxes
	...
	function BlobBounds_u8(label, width, height) {
		var blob = {};
		var offset = 0;
